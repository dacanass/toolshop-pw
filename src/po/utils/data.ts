export const userData = {
  email: ["customer@practicesoftwaretesting.com", "invalidEmail@example.com"],
  password: "welcome01",
  firstname: "David",
  lastname: "Canas",
  message: "El mensaje tiene mas de cincuenta caracteres!!!!!!",
  subject: ["Customer service", "Webmaster", "Return", "Payments", "Warranty", "Status of my order"],
